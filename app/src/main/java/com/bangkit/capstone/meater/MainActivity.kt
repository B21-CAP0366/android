...
import com.bangkit.capstone.meater.viewmodel.NewsViewModel
import com.bangkit.capstone.meater.viewmodel.ViewModelFactory
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.rvMeater.layoutManager = GridLayoutManager(this@MainActivity,2)
